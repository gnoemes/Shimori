...
/**
 * Scaffold version with full size content body
 *
...
@Composable
private fun ScaffoldExtendedLayout(
    ...
    SubcomposeLayout { constraints ->
        ...
        layout(layoutWidth, layoutHeight) {
            ...
            val bodyContentPlaceables = subcompose(ScaffoldLayoutContent.MainContent) {
                val innerPadding =
                    PaddingValues(bottom = bottomBarHeight.toDp(), top = topBarHeight.toDp())
